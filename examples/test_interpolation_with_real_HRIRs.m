...
xlabel('samples')
ylabel('amplitude')
title('Left ear HRIR without and with interpolation, dataset: FABIAN 3D')
...
xlabel('samples')
ylabel('amplitude')
title('Right ear HRIR without and with interpolation, dataset: FABIAN 3D')
legend('without interpolation','with interpolation')
...
xlabel('f/Hz')
ylabel('amplitude / db')
title('Left ear HRTF without and with interpolation, dataset: FABIAN 3D')
legend('without interpolation','with interpolation')
...
xlabel('f / Hz')
ylabel('amplitude / db')
title('Error between measured and interpolated HRTF (left ear)')
...
xlabel('f / Hz')
ylabel('amplitude / db')
title('Right ear HRTF without and with interpolation, dataset: FABIAN 3D')
legend('without interpolation','with interpolation')
...
xlabel('f / Hz')
ylabel('amplitude / db')
title('Error between measured and interpolated HRTF (right ear)')
...
% plot3(x1,y1,z1,'r.','MarkerSize',20)
% hold on
% plot3(x2,y2,z2,'b.','MarkerSize',20)
% hold on
% plot3(x3,y3,z3,'b.','MarkerSize',20)
% hold on
% plot3(x4,y4,z4,'b.','MarkerSize',20)
% hold on
% grid on 
% N =20;
